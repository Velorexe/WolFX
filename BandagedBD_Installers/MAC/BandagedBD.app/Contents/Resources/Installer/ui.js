...
if (available.includes('Discord')) {
    ...
    document.querySelector('#stablePath input').value  = "/Applications/Discord.app";
    document.querySelector('#uStablePath input').value = "/Applications/Discord.app";
    document.querySelector('#rStablePath input').value = "/Applications/Discord.app";
}
if (available.includes('Discord PTB')) {
    ...
    document.querySelector('#PTBPath input').value     = "/Applications/Discord PTB.app";
    document.querySelector('#uPTBPath input').value    = "/Applications/Discord PTB.app";
    document.querySelector('#rPTBPath input').value    = "/Applications/Discord PTB.app";
}
if (available.includes('Discord Canary')) {
    ...
    document.querySelector('#canaryPath input').value  = "/Applications/Discord Canary.app";
    document.querySelector('#uCanaryPath input').value = "/Applications/Discord Canary.app";
    document.querySelector('#rCanaryPath input').value = "/Applications/Discord Canary.app";
}
